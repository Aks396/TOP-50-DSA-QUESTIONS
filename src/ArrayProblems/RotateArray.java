...
/**
 * Question 2: Rotate an Array by K Steps
...
public class RotateArray {
    ...
    /**
     * Java 7 Approach: Reversal Algorithm
     */
    ...
    public static void rotateStream(int[] nums, int k) {
        ...
        List<Integer> rotated = IntStream.concat(
                ...
                Arrays.stream(nums, 0, n - rotation)).boxed().collect(Collectors.toList());
    ...
    public static void main(String[] args) {
        ...
        int k = 3;
        System.out.println("Input: " + Arrays.toString(data1) + ", k=" + k);
        rotate(data1, k);
